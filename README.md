...
The endpoint loads an OWASP ServerlessGoat page containing a form consisting of a single  user input textbox and submit button  
  as well as a list of potential vulnerabilities  
